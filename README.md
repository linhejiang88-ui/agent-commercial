...
| [`2026年软件及AI-Agent外包及咨询市场分析报告.md`](2026年软件及AI-Agent外包及咨询市场分析报告.md) | 简版正文 | 插图版的基础正文版本，适合做文字修订。 |
| [`2026年软件开发、数据分析与AI-Agent外包及咨询市场深度分析报告.md`](2026年软件开发、数据分析与AI-Agent外包及咨询市场深度分析报告.md) | 深度报告 | 补充数据分析外包、团队建议和更完整的产品量级分析。 |
...
5. 如需扩展正文，再参考深度报告和 [`报告插图规划.md`](报告插图规划.md)。
